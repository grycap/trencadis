 ...
 private boolean wrap(String filename, boolean inValidationMode){
	 try {
		 ...
		 if (inValidationMode) {
			 ...
			 parser.setProperty("http://apache.org/xml/properties/schema/external-noNamespaceSchemaLocation", "xmlOutputCreateOntology.xsd");
		 }
		 parser.setErrorHandler(new trencadis.infrastructure.services.KeyServer.impl.wrapper.xmlOutputUpdate.CustomErrorHandler());
...
/**
 * Obtiene un Wrapper a partir del elemento OUTPUT
