...
public class NUM extends DSRNode {

	private static String[] attrKeys = new String[]{
		"UNITS_CODE_VALUE", "UNITS_CODE_SCHEMA", "UNITS_CODE_MEANING", "VALUE"
	};
	...
	public void setUnitsSchema(String value) {
		attrValues[1] = value;
	}

	public void setUnitsMeaning(String value) {
		attrValues[2] = value;
	}
	...
	public void printDICOMSRBinaryObjectData(FileWriter fw, int treeLevel) throws IOException {
		...
		fw.write("(0040,a040) Value Type \"NUM\"\n");
		...
		fw.write("(0040,a300) Measured Value Sequence\n");
		fw.write("(fffe,e000) Item\n");
		fw.write("(0040,08ea) Measurement Units Code Sequence\n");
		fw.write("(fffe,e000) Item\n");
		...
		fw.write("(fffe,e00d) Item Delimitation Item\n");
		fw.write("(fffe,e0dd) Sequence Delimitation Item\n");
		fw.write("(0040,a30a) Numeric Value \"" + attrValues[3] + "\"\n");
		fw.write("(fffe,e00d) Item Delimitation Item\n");
		fw.write("(fffe,e0dd) Sequence Delimitation Item\n");
