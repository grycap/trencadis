...
public class CONTAINER extends DSRNode {
	...
	public CONTAINER() {
		attrValues[0] = "SEPARATE";
	}

	public void setContinuitySeparate() {
		attrValues[0] = "SEPARATE";
	}

	public void setContinuityContinuous() {
		attrValues[0] = "CONTINUOUS";
	}
	...
	public void printDICOMSRBinaryObjectData(FileWriter fw, int treeLevel) throws IOException {
		...
		fw.write("(0040,a040) Value Type \"CONTAINER\"\n");
		...
		fw.write("(0040,a050) Continuity of Content \"" + attrValues[0] + "\"\n");
